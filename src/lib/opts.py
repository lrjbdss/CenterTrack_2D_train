...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--save_framerate', type=int, default=25)
        self.parser.add_argument('--resize_video', action='store_true')
        self.parser.add_argument('--video_h', type=int, default=540, help='')
        self.parser.add_argument('--video_w', type=int, default=960, help='')
        ...
        self.parser.add_argument('--input_h', type=int, default=320,
                                 help='input height. -1 for default from dataset.')
        self.parser.add_argument('--input_w', type=int, default=320,
        ...
        # loss
        self.parser.add_argument('--tracking_weight', type=float, default=1.5)
